            ...
            <>
                                    ...
                                    {group.emps.map(emp => {
                                      ...
                                      return (
                                        <div key={emp.id} style={{ display:"flex", alignItems:"center", justifyContent:"space-between", padding:"8px 12px", borderRadius:"10px", background: isVac ? "#fff1f2" : "#f8fafc", border:`1px solid $isVac ? "#fecdd3" : "#f1f5f9"` }}>
                                          <div style={{ display:"flex", alignItems:"center", gap:"8px" }}>
                                            <div style={{ width:"32px", height:"32px", borderRadius:"50%", background:`linear-gradient(135deg, $group.color30, $group.color15)`, display:"flex", alignItems:"center", justifyContent:"center", fontSize:"13px", fontWeight:"900", color:group.color, flexShrink:0 }}>
                                              {emp.name.charAt(0)}
                                            </div>
                                            <div>
                ...
                <div className="space-y-5">
                  ...
                  <div style={{ background:"white", borderRadius:"20px", border:"1px solid #e2e8f0", boxShadow:"0 1px 4px rgba(0, 0, 0, 0.05)", overflow:"hidden" }}>
                    <div style={{ overflowX:"auto", overflowY:"auto", maxHeight:"calc(100vh - 280px)" }}>
                      <table style={{ borderCollapse:"collapse", border:"1px solid #94a3b8", width:"100%", fontSize:"13px", backgroundColor:"#ffffff" }}>
                        <thead>
              ...
              {activeTab === "holidays" && isOwner && (
                <div style={{ width:"100%", boxSizing:"border-box" }} className="space-y-6">
                  ...
                  <div className="bg-white rounded-[2rem] shadow-sm border overflow-x-auto">
                    <table className="w-full" style={{ borderCollapse:"collapse", border:"1px solid #94a3b8", width:"100%", fontSize:"13px", backgroundColor:"#ffffff" }}>
              ...
              {activeTab === "history" && (
                <div className="space-y-6">
                  ...
                  <div className="bg-white rounded-[2rem] shadow-sm border overflow-x-auto">
                    <table className="w-full text-sm" style={{ borderCollapse:"collapse", border:"1px solid #94a3b8", width:"100%", fontSize:"13px", backgroundColor:"#ffffff" }}>
