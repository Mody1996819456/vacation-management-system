...
تاريخ العودة: ${formatDate(back)}`);
  ...
  // طباعة النموذج المعتمد كما هو، مع وضع كل قيمة مرة واحدة فوق خانتها الأصلية.
...
<style>
  ...
  *{box-sizing:border-box}
  ...
  .template{position:absolute;inset:0;width:100%;height:100%;object-fit:fill;z-index:0}
  .write{position:absolute;z-index:2;color:#111;font-weight:700;line-height:1.25;white-space:pre-wrap;overflow:hidden;text-align:right;direction:rtl;background:rgba(255,255,255,.78);padding:1px 4px;border-radius:2px}
  .from{top:25.55%;right:8.5%;width:59%;font-size:13px}
  .inform{top:30.45%;right:7.5%;width:62%;font-size:13px}
  .name{top:34.55%;right:10.5%;width:45%;font-size:13px}
  .code{top:36.75%;right:10.5%;width:45%;font-size:13px}
  .position{top:38.95%;right:10.5%;width:45%;font-size:13px}
  .date{top:41.05%;right:31%;width:19%;font-size:12px;text-align:center}
  .offence{top:44.0%;right:8.5%;width:80%;height:5.25%;font-size:13px;padding:5px 7px}
  .manager{top:52.25%;right:13%;width:59%;font-size:13px}
  .statement{top:57.7%;right:7.5%;width:84%;height:8.8%;font-size:13px;padding:6px 8px}
  .action{top:69.4%;right:7.5%;width:84%;height:8.3%;font-size:13px;padding:6px 8px}
  @media print{.write{background:transparent}}
</style></head><body><div class="page">
  <img class="template" src="/penalty-form-template.webp" alt="Penalty Form" />
  <!-- كل قيمة تظهر مرة واحدة فقط في خانتها الأصلية -->
  <div class="write from">${value(dept?.name)}</div>
  <!-- لا نكرر سبب المخالفة في السطر التمهيدي؛ يُكتب مرة واحدة داخل خانة المخالفة -->
  <div class="write inform"></div>
